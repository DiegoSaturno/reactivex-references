...
- [A diferença entre SwitchMap e FlatMap](https://medium.com/codigorefinado/a-diferen%C3%A7a-entre-switchmap-e-flatmap-ou-mergemap-e38310fb65cb)

## [Operadores](http://reactivex.io/documentation/operators.html)
### Criação
- [Create](https://rxjs-dev.firebaseapp.com/api/index/class/Observable)
...
- [Pipe](https://rxjs-dev.firebaseapp.com/api/index/function/pipe)- [Debounce](https://rxjs-dev.firebaseapp.com/api/operators/debounce)
...
- [Join](https://rxjs-dev.firebaseapp.com/api/index/function/forkJoin)
